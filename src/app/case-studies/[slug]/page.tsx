...
const caseStudiesData: Record<string, {
    ...
    'barbershop-site': {
        ...
        subtitle: 'Site profissional para barbearia com agendamento e design premium',
        description: 'Site completo para a Império Barbearia com design dark e dourado, sistema de agendamento online, galeria de serviços com preços, apresentação da equipe, blog com dicas e newsletter para fidelização de clientes.',
        challenge: 'Criar uma presença digital premium para uma barbearia que transmitisse sofisticação e profissionalismo, com sistema de agendamento integrado e design que refletisse a identidade visual do estabelecimento.',
        solution: 'Desenvolvi um site responsivo com Next.js e TypeScript, utilizando Tailwind CSS para o design system com paleta dark e dourada. Implementei seções de serviços com precificação, galeria da equipe com personagens 3D, blog integrado e formulário de newsletter.',
        results: [
            'Design premium com identidade visual única',
            'Sistema de agendamento online integrado',
            'Blog com dicas para engajamento de clientes',
            'Performance otimizada com score 95+ no Lighthouse',
        ],
        technologies: ['Next.js', 'TypeScript', 'Tailwind CSS', 'Framer Motion', 'Vercel'],
        duration: '4 semanas',
        role: 'Full-Stack Developer',
        color: 'from-amber-500/40 to-yellow-500/30',
        image: '/images/cases/BarberSite1.png',
        liveUrl: 'https://barbershop-premium-woad.vercel.app/',
        githubUrl: '#',
    },
    'dashboard-analytics': {
